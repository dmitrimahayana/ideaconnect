...
$js=<<<EOP
	$('.search-form form').submit(function(){
		$.fn.yiiGridView.update('hooks-grid', {
			data: $(this).serialize()
		});
		return false;
	});

	/* jQuery('#hooks-grid a.delete').live('click',function() {
		if(!confirm('Are you sure you want to delete this item?')) return false;
		var th=this;
		var afterDelete=function(link,success,data){ if(success){ $('#ajax-status').html(data);} };

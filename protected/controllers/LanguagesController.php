<?php
/* LanguagesController* Handle LanguagesController* Copyright (c) 2012, SWEVEL. All rights reserved.
* version: 0.0.1
* Reference start
*
* TOC :
...
class LanguagesController extends /*SBaseController*/ Controller
{
	/**
				...
				if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
					if($model->save()) {
						echo CJSON::encode(array(
							'type' => 1,
							'id' => 'partial-languages',
							'msg' => '<div class="errorSummary success"><strong>'.Yii::t('', 'Bahasa berhasil ditambahkan.').'</strong></div>',
						));
					} else {
				...
				if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
					if($model->save()) {
						echo CJSON::encode(array(
							'type' => 1,
							'id' => 'partial-languages',
							'msg' => '<div class="errorSummary success"><strong>'.Yii::t('', 'Bahasa berhasil diperbarui.').'</strong></div>',
						));
					} else {
						print_r($model->getErrors());
					}
	...
	public function actionAdminDelete($id) {
		if(Yii::app()->request->isPostRequest) {
			...
			$data .= '<div class="dialog-header">'.Yii::t('', 'Hapus Bahasa').'</div>';

<?php
/* UsersController* Handle UsersController* Copyright (c) 2012, SWEVEL. All rights reserved.
* version: 0.0.1
* Reference start
*
* TOC :
...
class UsersController extends /*SBaseController*/ Controller
{
	/**
	...
	public function actionAdminDelete($id) {
		if(Yii::app()->request->isPostRequest) {
			...
			if(!isset($_GET['ajax'])) {
				Yii::app()->user->setFlash('success', Yii::t('', 'Users success deleted.'));

<?php
/* ZoneRegencyController* Handle ZoneRegencyController* Copyright (c) 2012, SWEVEL. All rights reserved.
* version: 0.0.1
* Reference start
*
* TOC :
...
class ZoneregencyController extends /*SBaseController*/ Controller
 {
	/**
	...
	public function actionIndex() {
		...
		$dataProvider=new CActiveDataProvider('ZoneRegency', array(
			//'criteria' => $criteria,
			//'pagination' => array(
			//	'size' => 10
			//)
	...
	public function actionAdminManage() {
		$model=new ZoneRegency('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ZoneRegency'])) {
			$model->attributes=$_GET['ZoneRegency'];
		}
	...
	public function actionAdminAdd() {
		$model=new ZoneRegency;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['ZoneRegency'])) {
			$model->attributes=$_POST['ZoneRegency'];
			if($model->save()) {
				Yii::app()->user->setFlash('success', Yii::t('', 'ZoneRegency success created.'));
	...
	public function actionAdminEdit($id) {
		...
		if(isset($_POST['ZoneRegency'])) {
			$model->attributes=$_POST['ZoneRegency'];
			if($model->save()) {
				Yii::app()->user->setFlash('success', Yii::t('', 'ZoneRegency success updated.'));
				$this->redirect(array('adminview','id'=>$model->id));
				//$this->redirect(array('adminmanage'));
			}
		}
		...
		if(Yii::app()->request->isPostRequest) {
			...
			if(isset($id)) {
				...
				echo CJSON::encode(array(
					'type' => 3,
					'id' => 'partial-zone-regency',
					'msg' => '<div class="errorSummary success"><strong>'.Yii::t('', 'ZoneRegency success deleted.').'</strong></div>',
			...
			$data .= '<div class="dialog-header">'.Yii::t('', 'Hapus ZoneRegency').'</div>';
	...
	public function loadModel($id) {
		$model=ZoneRegency::model()->findByPk($id);
		if($model===null)
	...
	protected function performAjaxValidation($model) {
		if(isset($_POST['ajax']) && $_POST['ajax']==='zone-regency-form') {

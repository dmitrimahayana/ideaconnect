...
class CityController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('CcnCity');
	...
	public function actionAdminAdd()
	{
		...
		if(isset($_POST['CcnCity']))
		{
			$model->attributes=$_POST['CcnCity'];
			if($model->save()) {
				Yii::app()->user->setFlash('success', Yii::t('', 'Kota berhasil ditambahkan.'));
	...
	public function actionAdminEdit($id)
	{
		...
		if(isset($_POST['CcnCity']))
		{
			$model->attributes=$_POST['CcnCity'];
			if($model->save()) {
				Yii::app()->user->setFlash('success', Yii::t('', 'Kota berhasil di ubah'));
				$this->redirect(array('adminview','id'=>$model->id));
				//$this->redirect(array('adminmanage'));
			}
		}
	...
	public function actionAdminDelete($id)
	{
		if(Yii::app()->request->isPostRequest) {
			...
			if(!isset($_GET['ajax'])) {
				Yii::app()->user->setFlash('success', Yii::t('', 'Kota berhasil di hapus.'));
	...
	{
		$model=new CcnCity('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['CcnCity'])) {
			$model->attributes=$_GET['CcnCity'];
		}
	...
	{
		$model=CcnCity::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='ccn-city-form')
		{

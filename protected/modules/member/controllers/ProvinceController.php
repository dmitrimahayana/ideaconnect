...
class ProvinceController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('CcnProvince');
	...
	{
		$model=new CcnProvince;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['CcnProvince']))
		{
			$model->attributes=$_POST['CcnProvince'];
			if($model->save()) {
				Yii::app()->user->setFlash('success', Yii::t('', 'Propinsi berhasil ditambah.'));
	...
	public function actionAdminEdit($id)
	{
		...
		if(isset($_POST['CcnProvince']))
		{
			$model->attributes=$_POST['CcnProvince'];
			if($model->save()) {
				Yii::app()->user->setFlash('success', Yii::t('', 'Provinsi berhasil diubah.'));
				$this->redirect(array('adminview','id'=>$model->id));
				//$this->redirect(array('adminmanage'));
			}
		}
	...
	public function actionAdminDelete($id)
	{
		if(Yii::app()->request->isPostRequest) {
			...
			if(!isset($_GET['ajax'])) {
				Yii::app()->user->setFlash('success', Yii::t('', 'Provinsi berhasil dihapus.'));
	...
	{
		$model=new CcnProvince('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['CcnProvince'])) {
			$model->attributes=$_GET['CcnProvince'];
		}
	...
	{
		$model=CcnProvince::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='ccn-province-form')
		{

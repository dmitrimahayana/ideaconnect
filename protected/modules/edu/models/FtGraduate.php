...
/**
 * This is the model class for table "ic_ft_graduate".
 *
 * The followings are the available columns in table 'ic_ft_graduate':
 * @property string $id
 ...
 */
class FtGraduate extends CActiveRecord
 {
	 ...
	 * @return FtGraduate the static model class
	 */
	...
	public function rules() {
		...
		return array(
			array('role_date, role_month, role_year, finish_date, finish_month, finish_year, student_number, member_id', 'required'),
			array('major_id, degree_id, role_date, role_month, role_year, finish_date, finish_month, finish_year', 'numerical', 'integerOnly'=>true),
			array('student_number', 'length', 'max'=>80),
			array('member_id', 'length', 'max'=>10),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, major_id, degree_id, role_date, role_month, role_year, finish_date, finish_month, finish_year, student_number, member_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels() {
		return array(
			...
			'finish_date' => Yii::t('label', 'Finish Date'),
			'finish_month' => Yii::t('label', 'Finish Month'),
			'finish_year' => Yii::t('label', 'Finish Year'),

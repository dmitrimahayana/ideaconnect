...
return array (
  ...
  "Save"=>"Simpan",
  "Create"=>"Tambah",
  "Managing AuthItem"=>"Kelola Autentikasi",
  "AuthItem List" => "Daftar Autentikasi",
  "New AuthItem" => "Autentikasi Baru",
  "Update"=>"Ubah",
  "Delete"=>"Hapus",
  "Users"=>"User",
  "Roles"=>"Roles",
  "Tasks"=>"Tasks",
  "Manage AuthItem"=>"Manage AuthItem",
  "Update AuthItem"=>"Update AuthItem",
  "Delete AuthItem"=>"Delete AuthItem",
  "View AuthItem"=>"View AuthItem",
  "Assign Operations to Tasks"=>"Assign Operations to Tasks",
  "Task"=>"Task",
  "Assign Roles to Users"=>"Assign Roles to Users",
  "User"=>"User",
  "Assign Tasks to Roles"=>"Assign Tasks to Roles",
  "Role"=>"Role",
...
/*   "Not Assigned Tasks"=>"Tareas No Asignadas",
  ...
  "You are not authorized for this action"=>"Anda tidak diijinkan untuk mengakses halaman ini, silahkan hubungi administrator kami.",
  "Error while trying to access"=>"Terjadi kesalahan saat mengakses alamat: ",
);
?>

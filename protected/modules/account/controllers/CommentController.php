<?php
/* CommentController* Handle CommentController* Copyright (c) 2012, SWEVEL. All rights reserved.
* version: 0.0.1
* Reference start
*
* TOC :
...
class CommentController extends /*SBaseController*/ Controller
 {
	/**
	...
	public function accessRules() {
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('adminmanage','adminadd','adminedit','adminview','admindelete','publish','project'),
				'users'=>array('@'),
			),
	...
	public function actionAdminAdd() {
		...
		if(isset($_POST['Comment'])) {
			...
			if($model->save()) {
				Yii::app()->user->setFlash('success', Yii::t('', 'Comment success created.'));
	...
	public function actionAdminEdit($id) {
		...
		if(isset($_POST['Comment'])) {
			$model->attributes=$_POST['Comment'];
			if($model->save()) {
				Yii::app()->user->setFlash('success', Yii::t('', 'Comment success updated.'));
				$this->redirect(array('adminview','id'=>$model->id));
				//$this->redirect(array('adminmanage'));
			}
		}
		...
		if(Yii::app()->request->isPostRequest) {
			...
			if(isset($id)) {
				...
				echo CJSON::encode(array(
					'type' => 3,
					'id' => 'partial-comment',
					'msg' => '<div class="errorSummary success"><strong>'.Yii::t('', 'Comment success deleted.').'</strong></div>',
			...
			$data .= '<div class="dialog-header">'.Yii::t('', 'Hapus Comment').'</div>';

...
/**
 * This is the model class for table "ic_badge".
 *
 * The followings are the available columns in table 'ic_badge':
 * @property integer $id
...
class Badge extends CActiveRecord
 {
	...
	public function relations() {
		...
		return array(
			'ic_badge_somes' => array(self::HAS_MANY, 'IcBadgeSome', 'badge_id'),
		);
	}

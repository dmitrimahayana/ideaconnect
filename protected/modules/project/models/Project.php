 ...
 * @property string $requisite_title
...
class Project extends CActiveRecord
 {
	...
	public function rules() {
		...
		return array(
			array('project_name, intro_text, tagline, video_url, background_title, background, description_title, description, goal_title, goal, requisite_title, invitation_title, invitation, created_time, edited_time', 'required'),
			...
			array('cover_image, intro_text, tagline, background_title, description_title, goal_title, requisite_title, invitation_title, as_institution_name', 'length', 'max'=>255),
	...
	public function attributeLabels() {
		return array(
            ...
            'project_time' => Yii::t('label', 'Lama Project (Bulan)'),
	...
	public function getGridColumn($columns=null) {
		if($columns !== null) {
			...
			$this->defaultColumns[] = 'requisite_title';
    ...
    public static function generateEdit($status){
        if($status == 0){
            return 'a';
        }else
            return 'b';

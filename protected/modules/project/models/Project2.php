...
class Project extends CActiveRecord
 {
	...
	public function rules() {
		...
		return array(
			array('project_name, cover_image, intro_text, tagline, video_url, background_title, background, description_title, description, goal_title, goal, invitation_title, invitation, charge_is_percentage, created_time, edited_time, is_actived, is_proposed, is_verified, ', 'required'),
			...
			array('cover_image, intro_text, tagline, background_title, description_title, goal_title, invitation_title, as_institution_name', 'length', 'max'=>255),
	...
	public function relations() {
		...
		return array(
			...
			'ic_faqs' => array(self::HAS_MANY, 'Faq', 'project_id'),
			'ic_progress_details' => array(self::HAS_MANY, 'ProgressDetail', 'project_id'),
			'ic_progress_infos' => array(self::HAS_MANY, 'ProgressInfo', 'project_id'),
			...
			'ic_project_requisites' => array(self::HAS_MANY, 'ProjectRequisite', 'project_id'),
	...
	public function attributeLabels() {
		return array(
			'id' => Yii::t('label', 'ID'),
			'project_name' => Yii::t('label', 'Project Name'),
			'cover_image' => Yii::t('label', 'Cover Image'),
			'intro_text' => Yii::t('label', 'Intro Text'),
			'tagline' => Yii::t('label', 'Tagline'),
			'geometry_location' => Yii::t('label', 'Geometry Location'),
			'project_category_id' => Yii::t('label', 'Project Category'),
			'project_category_inherit_id' => Yii::t('label', 'Project Category Inherit'),
			'project_category_name' => Yii::t('label', 'Project Category Name'),
			'project_category_name_inherit' => Yii::t('label', 'Project Category Name Inherit'),
			'video_url' => Yii::t('label', 'Video Url'),
			'background_title' => Yii::t('label', 'Background Title'),
			'background' => Yii::t('label', 'Background'),
			'description_title' => Yii::t('label', 'Description Title'),
			'description' => Yii::t('label', 'Description'),
			'goal_title' => Yii::t('label', 'Goal Title'),
			'goal' => Yii::t('label', 'Goal'),
			'invitation_title' => Yii::t('label', 'Invitation Title'),
			'invitation' => Yii::t('label', 'Invitation'),
			'charge' => Yii::t('label', 'Charge'),
			'charge_is_percentage' => Yii::t('label', 'Charge Is Percentage'),
			'project_time' => Yii::t('label', 'Project Time'),
			'created_time' => Yii::t('label', 'Created Time'),
			'editor_id' => Yii::t('label', 'Editor'),
			'edited_time' => Yii::t('label', 'Edited Time'),
			'is_actived' => Yii::t('label', 'Is Actived'),
			'is_proposed' => Yii::t('label', 'Is Proposed'),
			'inisiator_id' => Yii::t('label', 'Inisiator'),
			'inisiator_name' => Yii::t('label', 'Inisiator Name'),
			'is_verified' => Yii::t('label', 'Is Verified'),
			'verificator_id' => Yii::t('label', 'Verificator'),
			'verification_time' => Yii::t('label', 'Verification Time'),
			'project_started_time' => Yii::t('label', 'Project Started Time'),
			'project_ending_time' => Yii::t('label', 'Project Ending Time'),
			'is_funded' => Yii::t('label', 'Is Funded'),
			'as_institution_id' => Yii::t('label', 'As Institution'),
			'as_institution_name' => Yii::t('label', 'As Institution Name'),
		);
	}
    ...
    protected function beforeSave() {
        //if(parent::beforeSave()) {
          ...
          //  $this->verificator_id=Yii::app()->user->id_user;
        //}
        //return true;

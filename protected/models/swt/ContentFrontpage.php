...
/**
 * This is the model class for table "swt_content_frontpage".
 *
 * The followings are the available columns in table 'swt_content_frontpage':
 * @property integer $id
...
class ContentFrontpage extends CActiveRecord
{
	...
	public function rules()	{
		...
		return array(
			...
			array('id, content_id, ordering', 'safe', 'on'=>'search'),
		);
	}

...
/**
 * This is the model class for table "swt_content_section_lang".
 *
 * The followings are the available columns in table 'swt_content_section_lang':
 ...
 */
class ContentSectionLang extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return ContentSectionLang the static model class
	 */
	...
	public function tableName()	{
		return 'swt_content_section_lang';
	}
	...
	public function rules()	{
		...
		return array(
			array('content_section_id, lang_id, l_title, l_alias_url, l_description', 'required'),
			array('content_section_id', 'numerical', 'integerOnly'=>true),
			array('lang_id', 'length', 'max'=>6),
			array('l_title', 'length', 'max'=>80),
			array('l_alias_url', 'length', 'max'=>200),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('l_id, content_section_id, lang_id, l_title, l_alias_url, l_description', 'safe', 'on'=>'search'),
		);
	}
